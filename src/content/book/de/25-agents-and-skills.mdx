Da sich KI-Systeme von einfacher Frage-Antwort zu autonomer Aufgabenausführung entwickeln, wird das Verständnis von **Agents** und **Skills** essenziell. Dieses Kapitel erkundet, wie Prompts als fundamentale Bausteine für KI-Agents dienen, und wie Skills Expertise in wiederverwendbare, umfassende Anweisungspakete verpacken.
...
<div className="my-6 grid md:grid-cols-2 gap-4">
  ...
  <div className="border rounded-lg p-4 bg-muted/30">
    ...
    <p className="text-sm text-muted-foreground m-0!">Unterstützende Dokumentation, Beispiele und Kontext, auf die der Agent beim Arbeiten zugreifen kann.</p>
  </div>
  <div className="border rounded-lg p-4 bg-muted/30">
