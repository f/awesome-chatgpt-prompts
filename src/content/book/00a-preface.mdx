<div className="flex flex-col md:flex-row items-start gap-6 mb-8 p-6 bg-muted/50 rounded-lg">
  ...
  <div>
    ...
    <span className="block text-sm text-muted-foreground m-0!">
      Software developer from Istanbul, working as Developer Advocate at Automattic, in WordPress team. Author of books on JavaScript and prompt engineering. Open-source advocate specializing in web technologies and AI-assisted development.
    </span>
