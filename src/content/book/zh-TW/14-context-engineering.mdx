...
<InfoGrid items={[
  ...
  { label: "對話歷史", description: "此次聊天中的先前消息", color: "blue" },
  { label: "檢索資訊", description: "為此查詢獲取的文件、資料或知識", color: "green" },
...
<div className="my-6 p-4 border rounded-lg bg-muted/30">
  ...
  <div className="flex flex-col gap-2 text-sm">
    ...
    <div className="flex items-center gap-3">
      ...
      <span>傳送給 AI："根據此政策：[文字]，回答：我們的退款政策是什麼？"</span>
    </div>
    <div className="flex items-center gap-3">
...
<TryIt compact prompt={`你正在管理對話的上下文窗口。根據這些條件，決定何時觸發摘要：
