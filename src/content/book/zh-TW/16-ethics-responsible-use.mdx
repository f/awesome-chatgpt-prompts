...
<InfoGrid items={[
  ...
  { label: "非法活動", description: "助長違法行為的內容", example: "欺詐計劃、黑客指令、毒品合成", exampleType: "text", color: "red" },
  { label: "騷擾與仇恨", description: "針對個人或群體的內容", example: "歧視性內容、人肉搜尋、針對性騷擾", exampleType: "text", color: "red" },
  { label: "虛假資訊", description: "故意虛假或誤導性的內容", example: "假新聞、健康謠言、陰謀論內容", exampleType: "text", color: "red" },
  { label: "隱私侵犯", description: "暴露或利用個人資訊", example: "洩露私人資料、協助跟蹤", exampleType: "text", color: "red" },
...
CSAM是**兒童性虐待材料**（Child Sexual Abuse Material）的縮寫。在全球範圍內，製作、傳播或持有此類內容都是違法的。AI系統絕不能產生描繪未成年人涉及性情境的內容，負責任的提示詞工程師會主動建立防護措施，防止此類濫用。
</Callout>
...
<TryIt 
  title="安全優先的系統提示詞"
  description="一個將安全指南建構到AI系統中的模板。"
...
<InfoGrid items={[
  { label: "個人識別碼資訊", description: "姓名、地址、電話號碼、身份證號", example: "使用[客戶]代替 張三", color: "red" },
  ...
  { label: "私人通信", description: "私人郵件、消息、機密文件", example: "概述情況，而不引用私人文字", exampleType: "text", color: "red" }
]} />

### 安全的資料處理模式

<Compare 
  before={{ label: "不安全：包含PII", content: "總結張三在星光路123號關於訂單#12345的投訴：'我3月15日下單，到現在還沒收到...'" }}
  after={{ label: "安全：已匿名化", content: "總結這種客戶投訴模式：一位客戶3周前下單，至今未收到訂單，已聯繫客服兩次但未解決問題。" }}
/>

<Callout type="info" title="什麼是PII？">
**PII**是**個人可識別資訊**（Personally Identifiable Information）的縮寫——指任何可以識別特定個人身份的資料。這包括姓名、地址、電話號碼、電子郵件地址、身份證號、金融帳戶號碼，甚至是可能識別某人身份的資料組合（如職位+公司+城市）。在向AI傳送提示詞時，始終要對PII進行匿名化處理或刪除，以保護隱私。
</Callout>

<TryIt 
  title="PII清理器"
  description="在將文字納入提示詞之前，使用此工具識別和刪除敏感資訊。"
...
<InfoGrid items={[
  ...
  { label: "灰色地帶", description: "取決於具體情況，需要判斷", example: "代筆、模板、自動回覆", exampleType: "text", color: "amber" },
...
<InfoGrid items={[
  ...
  { label: "覆蓋能力", description: "當AI失敗時人工可以介入", example: "人工審核隊列、上報路徑", exampleType: "text", color: "blue" }
]} />
...
<TryIt 
  title="醫療場景免責聲明"
  description="可能收到健康相關查詢的AI系統的模板。"
...
<InfoGrid items={[
  { label: "法律諮詢", description: "提供一般資訊，而非法律建議", example: "這是一般性資訊。對於你的具體情況，請諮詢持證律師。", color: "purple" },
  { label: "財務諮詢", description: "教育性質，而非個人理財建議", example: "這是教育性內容。對於你的情況，請考慮諮詢理財顧問。", color: "purple" },
  { label: "管轄區意識", description: "法律因地區而異", example: "各省/國家法律不同。請核實你所在地區的要求。", color: "purple" }
]} />

### 兒童與教育

<InfoGrid items={[
  { label: "年齡適宜的內容", description: "確保輸出適合目標年齡群體", example: "過濾成人內容，使用適當的語言", exampleType: "text", color: "cyan" },
...
<Quiz 
  question="一個使用者問你的AI系統如何 擺脫一個煩人的人。最恰當的回應策略是什麼？"
  options={[
    "立即拒絕——這可能是請求傷害他人的指示",
    "提供衝突解決建議，因為這是最可能的意圖",
  ...
  correctIndex={2}
  explanation="模糊的請求需要澄清，而不是假設。擺脫某人 可能意味著結束友誼、解決職場衝突，或者某些有害的事情。提出澄清問題可以讓你針對實際意圖做出適當回應，同時對提供有害資訊保持謹慎。"
/>
