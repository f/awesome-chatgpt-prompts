...
2022年12月，在 ChatGPT 發佈僅幾周後，[Awesome ChatGPT Prompts](https://github.com/f/prompts.chat) 儲存庫在 GitHub 上建立了。這個概念簡單而強大：一個精心策劃的有效提示詞集合，任何人都可以使用和貢獻。
...
*Awesome ChatGPT Prompts 專案由 [@f](https://github.com/f) 和一個出色的貢獻者社群共同維護。前往 [prompts.chat](https://prompts.chat) 探索平台，並在 [GitHub](https://github.com/f/prompts.chat) 上加入我們一起貢獻。*
