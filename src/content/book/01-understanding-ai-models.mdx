...
Text-to-video is the newest frontier. Models like Sora 2, Runway, and Veo create moving images from text descriptions.
...
Video prompts need to describe action over time, not just a static scene. Include verbs and movement: "A bird takes flight from a branch" rather than "A bird on a branch."
</Callout>
