...
<FillInTheBlank
  ...
  description="Fill in the blanks to create a well-structured prompt following the 8 principles"
  useAI={true}
...
Format: Return your answer as {{format}}.`}
  blanks={[
    { id: "role", correctAnswers: ["senior developer", "software engineer", "technical writer", "data scientist"], hint: "What professional role should the AI assume?", context: "A job title or professional role" },
    { id: "expertise", correctAnswers: ["Python", "React", "web development", "data analysis", "machine learning"], hint: "What specific domain knowledge is needed?", context: "A technical skill or domain" },
    { id: "context", correctAnswers: ["a web application", "a mobile app", "a data pipeline", "an API"], hint: "What's the project or situation?", context: "A project type or work situation" },
    { id: "task", correctAnswers: ["Review this code", "Write a function", "Debug this issue", "Explain this concept"], hint: "What specific action should the AI take?", context: "An action verb with an object" },
    { id: "length", correctAnswers: ["200", "300", "500", "100"], hint: "How long should the response be?", context: "A number representing word count" },
    { id: "focus", correctAnswers: ["performance", "security", "readability", "best practices"], hint: "What aspect should be prioritized?", context: "A quality or aspect to focus on" },
    { id: "format", correctAnswers: ["a numbered list", "bullet points", "a table", "JSON", "markdown"], hint: "How should the output be structured?", context: "An output format type" }
  ]}
  explanation="A well-structured prompt includes: a clear role (Principle 1), sufficient context (Principle 3), specific task (Principle 2), constraints (Principle 4), and output format (Principle 5)."
/>
