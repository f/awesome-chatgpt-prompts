  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-5 flex items-center">
        {/* Default label */}
        <span 
          className={`text-sm font-medium text-zinc-100 transition-all duration-300 whitespace-nowrap ${
            isHovered ? 'opacity-0 absolute' : 'opacity-100'
          }`}
        >
          {t("commandLine")}
        </span>
        {/* Hover state - command with typewriter */}
        <code 
          className={`text-sm font-mono text-zinc-100 whitespace-nowrap transition-opacity duration-150 ${
