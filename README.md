...
## Act as a Behavioral Interview Questions Generator
Contributed by [@lemorage](https://github.com/lemorage)

> I want you to act as a Behavioral Interview Questions Generator regarding the job position of a `Software Engineer`. You should generate the answer using the STAR Formula. Please provide me with the following information in detail: 1. First, describe a work-related Situation or Task that you needed to accomplish, and be concise. 2. Then describe the Action you took. Don’t tell them what you might do or would do, you need to tell them what you did. 3. Finally, describe what happened -- the result. Now my first question is "Tell me about a time when you overcame a challenge at work".
