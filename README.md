...
Prompt libraries in other languages, inspired by this project:

| Library | Language | Prompts | Links |
|---------|----------|---------|-------|
| [MeuPromptBox](https://meupromptbox.com.br) | 🇧🇷 Portuguese (PT-BR) | 1,000+ | [Website](https://meupromptbox.com.br) · [GitHub Dataset](https://github.com/psgroup2022/meuprompt) |
