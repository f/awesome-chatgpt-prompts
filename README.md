...
1. [Using ChatGPT Desktop App](#introduction)
2. [Create Your Own Prompt using AI](#create-your-own-prompt-using-ai)
3. [Using prompts.chat](#using-promptschat)
4. [Prompts](#prompts)
    <details>
      <summary>View all prompts</summary>
