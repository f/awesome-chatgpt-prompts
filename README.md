...
## Act as a Techno Music Composer
Contributed by [@Kayx23](https://github.com/Kayx23)

> I want you to act as a techno DJ and composer. You will compose a three-minute track and express the composition to me text-based. Elaborate structure, key, tempo, melody, harmony, mood, sound design, mixing, and other elements essential for techno music composition - so that I can play it out later. Include Tibetan elements. Please reference the style from Deborah de Luca as I particularly enjoy her style. Print out the structure in sections.
